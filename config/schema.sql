...
CREATE TABLE IF NOT EXISTS patients (
    ...
    has_hmo ENUM('Yes', 'No') NOT NULL DEFAULT 'No',
    hmo_provider VARCHAR(150) NULL,
    hmo_card_number VARCHAR(80) NULL,
    hmo_type ENUM('Principal', 'Dependent') NULL,
    hmo_expiration_date DATE NULL,
    hmo_card_file VARCHAR(255) NULL,
    allergies TEXT NULL,
...
CREATE TABLE IF NOT EXISTS appointments (
    ...
    appointment_source ENUM('Walk-In', 'Facebook Page', 'Phone Call') NOT NULL DEFAULT 'Walk-In',
    dentist VARCHAR(120) NULL,
